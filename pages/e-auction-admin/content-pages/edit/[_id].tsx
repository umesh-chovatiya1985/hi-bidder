...
const EditContentPage: NextPage = () => {
    ...
    const submitEventHandler = async (e: any) => {
        ...
        if(!sourceFile){
            ...
            const fetchRespo = await fetch(mainApiUrl+'content-page/'+_id, {
                method: 'PUT',
    ...
    const getEditRecord = async () => {
        const editRecord = await fetch(mainApiUrl+"content-page/"+_id);
        ...
        if(editRecord.ok){
            ...
            if(response.meta_image){
                setFile("/images/"+response.meta_image);
            }
        }
    }
    useEffect(() => {
   ...
   const headerProps = {pageTitle: process.env.COMPANY_NAME! + ' | Edit Content Page',pageDescription: process.env.COMPANY_NAME! + ' - Edit Content Page'};
   return (
       <>
           <Head>
                        ...
                        <div className="flex h-full">
                            ...
                            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-white border-0">
                                ...
                                <div className="py-3 text-blue-800 text-center mb-3 font-bold">
                                    <p className='text-xl capitalize'>Edit Content Page</p>
                                </div>
                                {apiError && <>
