...
const HelpLists: NextPage = () => {
  ...
  const baseEndpoint: any = "helps/help-list";
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (tableProps: any) => (
        <>
          <Link href={"/e-auction-admin/help-lists/edit/" + tableProps._id}>
          ...
          {/* <Link href={"/e-auction-admin/help-lists/view/" + tableProps._id}>
      ...
      <div className="p-6 pt-0">
        <div className="row">
          ...
          <div className="col-md-4 mt-3 text-right">
            <Link href={"/e-auction-admin/help-lists/add"}>
