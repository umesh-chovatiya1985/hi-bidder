...
const HelpCategory: NextPage = () => {
  ...
  const baseEndpoint: any = "helps/help-category";

  const fetchHelpCategory = async (page: any) => {
    setLoading(true);
    try {
  ...
  useEffect(() => {
    fetchHelpCategory(0); // fetch page 1 of users
  }, []);
  ...
  const columns = [
    {
      name: "Help Topic",
      selector: (row: any) => row.topic_id.topic_name,
    },
    {
      name: "Help Category",
      selector: (row: any) => row.help_category,
    },
    {
      name: "Help Category Description",
      selector: (row: any) => row.description,
    },
    {
      name: "Help Category Photo",
      cell: (tableProps: any) => (
        <>
          <img
      ...
      <div className="p-6 pt-0">
        <div className="row">
          ...
          <div className="col-md-4 mt-3 text-right">
            <Link href={"/e-auction-admin/help-category/add"}>
